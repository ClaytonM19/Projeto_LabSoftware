              ...
              <td>${person.usuario}</td>
                <td>${person.email}</td>
                  <td>${person.telefone}</td>
                    <td><a href='http://localhost:3333/editar/${person.id}' ><button>Editar</button></a></td>
...
app.put('/atualizar/:id', (req,res)=>{
    ...
    db.query(sql, [usuario, email, telefone, id], (err, results)=>{
        ...
        res.send("O cadastro foi atualizado com sucesso!")
    })
...
app.delete('/deletar/:id', (req,res)=>{
    ...
    db.query(sql, [id], (err, results)=>{
        ...
        res.send("O cadastro foi deletado com sucesso!")
    })
